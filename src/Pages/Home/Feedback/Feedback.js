    ...
    return (
        <div className="col-lg-10 text-white mx-auto mb-5">
            ...
            <div className="feedback">
                <div className="mx-3 mb-3 bg-danger border-0 rounded-3">
                    <img className="w-100 border-0 rounded-3 p-4" src="https://images.unsplash.com/photo-1562159278-1253a58da141?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
                ...
                <div className="mx-3 mb-3 bg-warning border-0 rounded-3">
                    <img className="w-100 border-0 rounded-3 p-4 img-fluid" src="https://images.unsplash.com/photo-1445404590072-16ef9c18bd83?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" />
                ...
                <div className="mx-3 mb-3 bg-success border-0 rounded-3">
                    <img className="w-100 border-0 rounded-3 p-4" src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
